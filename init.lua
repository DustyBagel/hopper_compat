...
if minetest.registered_nodes["hopper:hopper_void"] then 
	if minetest.Settings:get_bool("warning_message") or true then
		minetest.register_on_newplayer(function(player)
   	 	    minetest.chat_send_player(player:get_player_name(), "Hopper compatibility's connected_chests support doesn't work with this version of the hoppers mod. All other mod support should work but this needs to be tested. The right version can be found here: https://content.minetest.net/packages/FaceDeer/hopper/.")
		end)
	end
